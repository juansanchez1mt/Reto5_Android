package com.example.reto5.datos;
...
import com.example.reto5.adaptadores.ProductoAdapter;
import com.example.reto5.adaptadores.ServicioAdapter;
import com.example.reto5.adaptadores.SucursalAdapter;
import com.example.reto5.casos_uso.CasoUsoProducto;
import com.example.reto5.casos_uso.CasoUsoServicio;
import com.example.reto5.casos_uso.CasoUsoSucursal;
import com.example.reto5.modelos.Producto;
import com.example.reto5.modelos.Servicio;
import com.example.reto5.modelos.Sucursal;
...
public class ApiOracle {
    ...
    private String urlSucursales = "https://gdbed69c81f5be5-dbreto5.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/sucursales/sucursales";
    private String urlProductos = "https://gdbed69c81f5be5-dbreto5.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/productos/productos";
    private String urlServicios = "https://gdbed69c81f5be5-dbreto5.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/servicios/servicios";
    ...
    public void getProductoById(String id, ImageView imageView, EditText name, EditText description, TextView location, GoogleMap googleMap){
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, urlProductos + "/" + id, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    //location.setText(producto.getLocation());
                    MarkerOptions markerOptions = new MarkerOptions();
                    //markerOptions.position(producto.locationToCoord());
    ...
    public void getServicioById(String id, ImageView imageView, EditText name, EditText description, TextView location, GoogleMap googleMap){
