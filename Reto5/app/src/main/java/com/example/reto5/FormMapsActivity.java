...
import com.example.reto5.datos.ApiOracle;
import com.example.reto5.datos.DBHelper;
...
import com.example.reto5.databinding.ActivityFormMapsBinding;
...
public class FormMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        insertSuc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                limpiar();
                Toast.makeText(getApplicationContext(), "Se inserto correctamente, espere mientras se carga la imagen", Toast.LENGTH_LONG).show();
            }
        });
    ...
    public void limpiar(){
        ...
        description.setText("");
        location.setText("");
        imgSelectedSuc.setImageResource(R.drawable.ic_baseline_cleaning_services_24);
    }
    @Override
